...
function Menu(){
  ...
  return(
    <main className = "menu">
      ...
      {numPizzas > 0 ? (
        <>
         <p>Aunthetic Italian cuisine, 6 creative dishes to chose from.All from
      ...
      <Pizza name = "Pizza Funghi" ingredients = "Tomato, mozarella, mushrooms, and onion" photoName = "./Pizzas/funghi.jpg" price = {20}/> */}
    </main>
  )
}
